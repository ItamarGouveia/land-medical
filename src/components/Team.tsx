        ...
        <section id="team" className="py-20 bg-white">
            ...
            <div className="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="text-center">
                    <img src="/med1.png" alt="Dr. João" className="w-40 h-40 rounded-full mx-auto mb-4" />
                    <h3 className="text-2xl font-semibold">Dr. João Silva</h3>
                    <p>Pediatra especializado em neonatologia.</p>
                </div>
                <div className="text-center">
                    <img src="/med2.jpg" alt="Dra. Maria" className="w-40 h-40 rounded-full mx-auto mb-4" />
                ...
                <div className="text-center">
                    <img src="/med3.jpg" alt="Dra. Marcos" className="w-40 h-40 rounded-full mx-auto mb-4" />
